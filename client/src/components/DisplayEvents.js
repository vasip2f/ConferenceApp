...
import 'react-clock/dist/Clock.css';
// import { events } from '../../../server/models/signuser';

function DisplayEvents() {

    const [value, onChange] = useState(['10:00', '11:00']);
    const [value1, onChange1] = useState(['11:00', '12:00']);
    const [value2, onChange2] = useState(['12:00', '01:00']);
    ...
    return (
        <div >
            ...
            <h1 className='text-danger' style={{color:'red'}}>𝑩𝒐𝒐𝒌𝒆𝒅 𝑬𝒗𝒆𝒏𝒕𝒔</h1>
            <div className='row'>
                        ...
                        <tbody>
                            {Data.map((item) =>
                                <tr key={item._id}>
                                    ...
                                    <td>{item.EndTime}</td>
                                    <td style={{color:'blue'}}>{item.username}</td>
